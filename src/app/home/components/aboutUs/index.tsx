      ...
      <div className={styles.containerContent}>
        ...
        >
          <p className={styles.text}>
            ...
            design is a deeply personal and client-centric service,
            fundamentally driven by your vision. This belief is what fuels the
            passion and dedication of every team member at BAKIA. Over the
            years, we have tirelessly refined our processes to ensure we fully
            understand and enhance your vision.
          </p>
